...
open class AdjacencyMatrixGraph<T>: AbstractGraph<T> where T: Hashable {
    ...
    open override func addDirectedEdge(_ from: Vertex<T>, to: Vertex<T>, withWeight weight: Double?, desc: TransitionDescription) {
        super.addDirectedEdge(from, to: to, withWeight: weight, desc: desc)
